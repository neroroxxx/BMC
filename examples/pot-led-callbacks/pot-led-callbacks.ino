...
void setup(){
  ...
  // when a potentiometer has been turned
  bmc.onPotActivity(onPotActivity);
...
void onPotActivity(uint8_t index, uint8_t value, bmcStorePot data){
  BMC_PRINTLN("Pot", index, "value", value);
}
