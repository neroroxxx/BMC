...
#include "devices/physical/auxJacks/BMC-AuxJackPot.h"
#include "devices/physical/auxJacks/BMC-AuxJackButton.h"
// 0 = buttons, 1 = pot
...
public:
  ...
  void begin(uint8_t t_potPin, uint8_t t_btnPin, uint8_t t_btnEnPin){
    ...
    BMC_PRINTLN("BMCAuxJack potPin:", potPin, "/ btnPin:", btnPin, "/ btnEnPin:", btnEnPin);
  }
