#ifndef _BMC_ST7735H_
#define _BMC_ST7735H_
...
class BMC_ST7735 : public BMC_ST77xx {
public:
  BMC_ST7735(int8_t cs, int8_t dc, int8_t mosi, int8_t sclk, int8_t rst);
  BMC_ST7735(int8_t cs, int8_t dc, int8_t rst);
#if !defined(ESP8266)
  BMC_ST7735(SPIClass *spiClass, int8_t cs, int8_t dc, int8_t rst);
#endif // end !ESP8266
