...
#elif defined(__AVR__) || defined(TEENSYDUINO) || defined(__IMXRT1062__)
...
*/
/**************************************************************************/
BMC_ILI9341::BMC_ILI9341(int8_t cs, int8_t dc, int8_t mosi,
...
*/
/**************************************************************************/
BMC_ILI9341::BMC_ILI9341(int8_t cs, int8_t dc, int8_t rst)
...
*/
/**************************************************************************/
BMC_ILI9341::BMC_ILI9341(SPIClass *spiClass, int8_t dc, int8_t cs,
                                   int8_t rst)
...
*/
/**************************************************************************/
BMC_ILI9341::BMC_ILI9341(tftBusWidth busWidth, int8_t d0, int8_t wr,
...
*/
/**************************************************************************/
void BMC_ILI9341::begin(uint32_t freq) {
...
*/
/**************************************************************************/
void BMC_ILI9341::setRotation(uint8_t m) {
...
*/
/**************************************************************************/
void BMC_ILI9341::invertDisplay(bool invert) {
...
*/
/**************************************************************************/
void BMC_ILI9341::scrollTo(uint16_t y) {
  uint8_t data[2];
  data[0] = y >> 8;
  data[1] = y & 0xff;
 ...
 */
/**************************************************************************/
void BMC_ILI9341::setScrollMargins(uint16_t top, uint16_t bottom) {
...
*/
/**************************************************************************/
void BMC_ILI9341::setAddrWindow(uint16_t x1, uint16_t y1, uint16_t w,
                                     uint16_t h) {
 ...
 */
/**************************************************************************/
uint8_t BMC_ILI9341::readcommand8(uint8_t commandByte, uint8_t index) {
