...
// the overall maximum brightness will be set by BMC_PIXEL_MAX_BRIGHTNESS
  ...
  #define BMC_COLOR_RGB_GREEN 0x00CC00
#endif
  ...
  #define BMC_COLOR_RGB_MAGENTA 0xFF004C
#endif
#ifndef BMC_COLOR_RGB_CYAN
  #define BMC_COLOR_RGB_CYAN 0x00E5FF
#endif
...
#endif
#ifndef BMC_COLOR_RGB_LIGHT_BLUE
  #define BMC_COLOR_RGB_LIGHT_BLUE 0x007FCC
#endif
#ifndef BMC_COLOR_RGB_ORANGE
  #define BMC_COLOR_RGB_ORANGE 0xFF3300
#endif
#ifndef BMC_COLOR_RGB_TEAL
  #define BMC_COLOR_RGB_TEAL 0x199999
#endif
...
#define BMC_PIXEL_MULTIPLIER (BMC_PIXEL_MAX_BRIGHTNESS+1)
...
#endif
#ifndef BMC_COLOR_RGB_DIM_LIGHT_BLUE
  #define BMC_PIXEL_DIM_B_PERCENT_LIGHT_BLUE ((uint8_t)ceil( (((BMC_COLOR_RGB_LIGHT_BLUE)&0xFF) / (BMC_PIXEL_MAX_BRIGHTNESS+0.0)) * (BMC_PIXEL_DIM_BRIGHTNESS) ))
  #define BMC_PIXEL_DIM_G_PERCENT_LIGHT_BLUE ((uint8_t)ceil( ((((BMC_COLOR_RGB_LIGHT_BLUE)>>8)&0xFF)/(BMC_PIXEL_MAX_BRIGHTNESS+0.0)) * (BMC_PIXEL_DIM_BRIGHTNESS)))
  #define BMC_PIXEL_DIM_R_PERCENT_LIGHT_BLUE ((uint8_t)ceil( ((((BMC_COLOR_RGB_LIGHT_BLUE)>>16)&0xFF)/(BMC_PIXEL_MAX_BRIGHTNESS+0.0)) * (BMC_PIXEL_DIM_BRIGHTNESS)))
  #define BMC_COLOR_RGB_DIM_LIGHT_BLUE ( BMC_PIXEL_DIM_B_PERCENT_LIGHT_BLUE | ((BMC_PIXEL_DIM_G_PERCENT_LIGHT_BLUE) << 8) | ((BMC_PIXEL_DIM_R_PERCENT_LIGHT_BLUE) << 16) )
#endif
  ...
  #define BMC_PIXEL_DIM_B_PERCENT_RAINBOW ((uint8_t)ceil( (((BMC_COLOR_RGB_RAINBOW)&0xFF) / (BMC_PIXEL_MAX_BRIGHTNESS+0.0)) * (BMC_PIXEL_DIM_BRIGHTNESS) ))
  #define BMC_PIXEL_DIM_G_PERCENT_RAINBOW ((uint8_t)ceil( ((((BMC_COLOR_RGB_RAINBOW)>>8)&0xFF)/(BMC_PIXEL_MAX_BRIGHTNESS+0.0)) * (BMC_PIXEL_DIM_BRIGHTNESS)))
  #define BMC_PIXEL_DIM_R_PERCENT_RAINBOW ((uint8_t)ceil( ((((BMC_COLOR_RGB_RAINBOW)>>16)&0xFF)/(BMC_PIXEL_MAX_BRIGHTNESS+0.0)) * (BMC_PIXEL_DIM_BRIGHTNESS)))
...
public:
  static uint32_t getRgbColor(uint8_t t_color){
    switch(t_color & 0x7F){
      ...
      case BMC_COLOR_LIGHT_BLUE: return BMC_COLOR_RGB_LIGHT_BLUE;
  ...
  static uint32_t getDimmedColor(uint8_t t_index){
    ...
    switch(t_index){
      ...
      case BMC_COLOR_LIGHT_BLUE: return BMC_COLOR_RGB_DIM_LIGHT_BLUE;
