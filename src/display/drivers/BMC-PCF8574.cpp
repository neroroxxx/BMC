...
BMC_PCF8574::BMC_PCF8574(uint8_t i2cAddr)
{
...
BMC_PCF8574::BMC_PCF8574(uint8_t i2cAddr, uint8_t rs, uint8_t enable,
    uint8_t d4, uint8_t d5, uint8_t d6, uint8_t d7, uint8_t backlight)
{
  init(i2cAddr, rs, 255, enable, d4, d5, d6, d7, backlight);
} // BMC_PCF8574

BMC_PCF8574::BMC_PCF8574(uint8_t i2cAddr, uint8_t rs, uint8_t rw, uint8_t enable,
    uint8_t d4, uint8_t d5, uint8_t d6, uint8_t d7, uint8_t backlight)
{
  init(i2cAddr, rs, rw, enable, d4, d5, d6, d7, backlight);
} // BMC_PCF8574

void BMC_PCF8574::init(uint8_t i2cAddr, uint8_t rs, uint8_t rw, uint8_t enable,
    uint8_t d4, uint8_t d5, uint8_t d6, uint8_t d7, uint8_t backlight)
{
  _i2cAddr = i2cAddr;
  _backlight = 0;
...
void BMC_PCF8574::begin(uint8_t cols, uint8_t lines, TwoWire &wirePort)
{
...
void BMC_PCF8574::setCursor(uint8_t col, uint8_t row)
{
  // check boundaries
...
void BMC_PCF8574::scrollDisplayLeft(void)
{
...
void BMC_PCF8574::scrollDisplayRight(void)
{
  // Instruction: Cursor or display shift = 0x10
...
void BMC_PCF8574::leftToRight(void)
{
...
void BMC_PCF8574::rightToLeft(void)
{
...
void BMC_PCF8574::autoscroll(void)
{
...
void BMC_PCF8574::noAutoscroll(void)
{
...
void BMC_PCF8574::setBacklight(uint8_t brightness)
{
...
void BMC_PCF8574::createChar(uint8_t location, uint8_t charmap[])
{
...
void BMC_PCF8574::createChar_P(uint8_t location, const uint8_t *charmap) {
...
inline size_t BMC_PCF8574::write(uint8_t ch)
{
  _send(ch, true);
...
void BMC_PCF8574::_send(uint8_t value, bool isData)
{
...
void BMC_PCF8574::_writeNibble(uint8_t halfByte, bool isData)
{
...
// write a nibble / halfByte with handshake
void BMC_PCF8574::_sendNibble(uint8_t halfByte, bool isData)
{
  _i2cPort->beginTransmission(_i2cAddr);
...
void BMC_PCF8574::_write2Wire(uint8_t data, bool isData, bool enable)
{
  if (isData)
    data |= _rs_mask;
  // _rw_mask is not used here.
